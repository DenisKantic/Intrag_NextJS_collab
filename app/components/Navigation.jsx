...
export default function Navigation() {
  return (
    ...
    <div className='xxs:px-5 xxs:w-full xxs:mx-auto mdd:px-10 xxl:px-40'>
         {/*px-40 pt-6' */}
        <nav className='flex p-4 items-center bg-gradient-to-r from-fuchsia-50 via-green-100 to-amber-50 rounded-lg bg-repeat-x
            ...
            <div>
                <ul className='flex xxs:w-full ml-5'>
                    <Link href="#AboutUs" className='xxs:mr-5 sm:mr-14 cursor-pointer xxs:text-sm md:text-lg font-medium lg:text-xl hover:text-slate-500'>O nama</Link>
                    <Link href="#Products" className='xxs:mr-5 sm:mr-14 cursor-pointer xxs:text-sm md:text-lg  lg:text-xl font-medium hover:text-slate-500'>Proizvodi</Link>
                    <Link href="#Contact" className='cursor-pointer xxs:text-sm md:text-lg font-medium lg:text-xl hover:text-slate-500'>Kontakt</Link>
                </ul>
            </div>
            <div>
